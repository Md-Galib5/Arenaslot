        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4 mt-8">
              ...
              <button className="w-full sm:w-auto bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-xl font-semibold transition duration-300 shadow-md hover:shadow-green-300">
                Explore Facilities
              </button>

              <button className="w-full sm:w-auto border border-gray-300 hover:border-green-500 px-8 py-3 rounded-xl font-semibold text-gray-800 transition duration-300">
                Become a Host
              </button>
          ...
          >
            ...
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-xl">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 bottom-[-40px] sm:bottom-6 bg-white rounded-2xl shadow-2xl border border-gray-100 w-[92%] sm:w-[85%] px-4 sm:px-6 py-4">
